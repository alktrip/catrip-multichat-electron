...
function assignPt(en) {
  ...
  Object.assign(en.settings.general, {
    ...
    "registerProtocolHint": "whatsapp:// — Após registrar, o sistema pode abrir links compatíveis diretamente no Catrip.",
    ...
    "updateChannelHint": "AppImage: baixa e instala ao reiniciar. Instalação .deb: você pode baixar o pacote para uma pasta ou abrir só o link do GitHub; o changelog e o SHA-512 do .deb aparecem no diálogo.",
    ...
    "downloadsFilenameHint": "O WhatsApp Web controla o nome do arquivo. Se já existir, será gerado um nome alternativo.",
    "waylandBrowserTitle": "https://wa.me no navegador",
    "waylandBrowserIntro": "No Wayland/Linux, o navegador não repassa links HTTPS para apps arbitrários. Opções práticas:",
    "waylandOption1": "Usar links que redirecionem para whatsapp:// (ex.: de outro app ou favorito).",
    "waylandOption2": "No navegador: menu do link → Abrir com… → Catrip Connect (se aparecer após registrar).",
    "waylandOption3": "Extensão do navegador que envie wa.me ao protocolo (não incluída no Catrip).",
    "waylandOption4": "No app: Ctrl+M (chat por número) ou colar o link se o sistema entregar ao Catrip.",
  ...
  Object.assign(en.settings.accounts, {
    ...
    "deleteWarning": "Toda a sessão do WhatsApp Web será excluída permanentemente (cookies, armazenamento local, IndexedDB, Service Workers e cache HTTP). Não pode ser desfeito.",
  ...
  Object.assign(en.settings.notifications, {
    ...
    "riseHint": "Aviso quando aumentam as não lidas em qualquer conta (limite por conta). Ao clicar, foca a janela e ativa essa conta."
  });
  Object.assign(en.settings.performance, {
    "gpuBoost": "Reforço de GPU ao iniciar (experimental)",
    "gpuInfo": "O Catrip Connect usa a GPU do Chromium para a janela, o rail e cada conta do WhatsApp Web. No Linux a janela é opaca por padrão (melhor composição). Desative a GPU só se a tela ficar preta: CATRIP_DISABLE_GPU=1.",
    "gpuBoostHint": "Ativa rasterização reforçada, zero-copy e VA-API ampliado no Linux. Reinicie o app após mudar isto ou o limite de processos.",
    ...
    "suspendHint": "Libera RAM fechando a vista do WhatsApp das contas não usadas; a sessão (cookies) permanece. Ao voltar, recarrega na hora. Em repouso, avisos dessa conta podem não atualizar.",
    "inhibitSleep": "Evitar suspensão durante videochamada",
    "inhibitSleepHint": "Usa o bloqueio de energia do Electron (semelhante a portal/systemd-inhibit no Linux) enquanto o WhatsApp Web detecta chamada ativa.",
    ...
    "storageHint": "Limpa o cache HTTP de todas as contas (economiza espaço; em geral mantém a sessão).",
    "mediaDiagSection": "Diagnóstico multimídia (WhatsApp Web)",
    "mediaDiagHint": "Verifica se o Chromium reproduz codecs típicos de vídeo/áudio na sessão da conta ativa (mesma janela do WhatsApp Web). Funciona mesmo nesta tela de configurações.",
    "mediaDiagFootnote": "Se decodingInfo_mp4_h264_aac.supported for false ou o MediaSource rejeitar MIME de MP4, áudio/vídeo no WhatsApp podem falhar."
  });
  ...
  Object.assign(en.app.onboarding, {
    ...
    "subtitle": "Cliente multiconta do WhatsApp Web. Adicione sua primeira conta para conversar no desktop.",
  ...
  Object.assign(en.app.rail, {
    ...
    "tooltip": "{{label}} · {{status}}{{unread}}{{suspended}} · Arraste para reordenar · Clique direito: variante"
  });
  ...
  Object.assign(en.app.about, {
    ...
    "inspired": "Inspirado em ideias do projeto ZapZap (PyQt6 + WebEngine). Implementação independente em Electron."
  });
  ...
  Object.assign(en.pending, {
    ...
    "subtitle": "Conversas não lidas de todas as contas, por urgência. Clique para abrir no WhatsApp Web.",
  ...
  Object.assign(en.main.integrations, {
    ...
    "protocolRegistered": "whatsapp:// registrado e ações do lançador atualizadas. Links https://wa.me no navegador não vão automaticamente ao Catrip: use whatsapp://, Abrir com… do navegador ou uma extensão.",
  ...
  Object.assign(en.main.diagnostics, {
    ...
    "whatsappNotLoaded": "A conta ativa ainda não mostra web.whatsapp.com. Abra o WhatsApp Web no navegador integrado e tente de novo.",
...
function assignFr(en) {
  ...
  Object.assign(en.settings.general, {
    ...
    "registerProtocolHint": "whatsapp:// — Après enregistrement, le système peut ouvrir les liens compatibles dans Catrip.",
    ...
    "updateChannelHint": "AppImage : télécharge et installe au redémarrage. .deb : téléchargez le paquet dans un dossier ou ouvrez le lien GitHub ; changelog et SHA-512 du .deb dans la boîte de dialogue.",
    ...
    "waylandBrowserIntro": "Sous Wayland/Linux, le navigateur ne transmet pas les liens HTTPS. Options :",
  ...
  Object.assign(en.settings.accounts, {
    ...
    "deleteWarning": "Toute la session WhatsApp Web sera supprimée (cookies, stockage, IndexedDB, Service Workers, cache HTTP). Irréversible.",
  ...
  Object.assign(en.settings.notifications, {
    ...
    "riseHint": "Alerte quand les non-lus augmentent (limite par compte). Un clic focalise la fenêtre et active le compte."
  });
  Object.assign(en.settings.performance, {
    "gpuBoost": "Boost GPU au démarrage (expérimental)",
    "gpuInfo": "Catrip Connect utilise le GPU Chromium. Sous Linux fenêtre opaque par défaut. Désactivez seulement si écran noir : CATRIP_DISABLE_GPU=1.",
    "gpuBoostHint": "Active rasterisation renforcée, zero-copy et VA-API étendu sous Linux. Redémarrez après modification ou limite de processus.",
    ...
    "suspendHint": "Libère la RAM en fermant WhatsApp des comptes inutilisés ; session conservée. Retour instantané. En veille, notifications peuvent ne pas se mettre à jour.",
    ...
    "mediaDiagFootnote": "Si decodingInfo_mp4_h264_aac.supported est false ou MediaSource rejette MP4, audio/vidéo peut échouer."
  });
  Object.assign(en.settings.network, {
    "proxy": "Proxy réseau",
  ...
  Object.assign(en.app.rail, {
    ...
    "tooltip": "{{label}} · {{status}}{{unread}}{{suspended}} · Glisser pour réordonner · Clic droit : variante"
  });
  Object.assign(en.app.palette, {
  ...
  Object.assign(en.pending, {
    ...
    "subtitle": "Discussions non lues de tous les comptes, par urgence. Cliquez pour ouvrir dans WhatsApp Web.",
  ...
  Object.assign(en.main.updates, {
    ...
    "integrityFail": "La somme SHA-512 du fichier téléchargé ne correspond pas à celle publiée sur GitHub.",
    ...
    "debPromptHint": "Télécharger le paquet .deb dans un dossier de votre choix ?\n(Sinon, vous pourrez ouvrir le lien GitHub.)",
    "debManualFooterHint": "Téléchargez l'installateur .deb depuis :\n{{debUrl}}\n\nPuis installez-le avec apt ou votre gestionnaire de paquets.",
    "debInstallHint": "Installez avec :\nsudo apt install ./{{filename}}",
    "restartFooterHint": "L'application redémarrera pour appliquer la mise à jour.{{integrityLine}}",
    "previewFooterHint": "Aperçu du dialogue de mise à jour (développement). Faites défiler pour lire toutes les notes.",
  ...
  Object.assign(en.main.integrations, {
    ...
    "protocolRegistered": "whatsapp:// enregistré. Les liens https://wa.me ne passent pas automatiquement : utilisez whatsapp://, Ouvrir avec… ou une extension.",
  ...
  Object.assign(en.main.diagnostics, {
    ...
    "whatsappNotLoaded": "Le compte actif n'affiche pas encore web.whatsapp.com. Ouvrez WhatsApp Web dans le navigateur intégré et réessayez.",
...
function assignDe(en) {
  ...
  Object.assign(en.settings.general, {
    ...
    "registerProtocolHint": "whatsapp:// — Nach Registrierung kann das System kompatible Links in Catrip öffnen.",
    ...
    "updateChannelHint": "AppImage: lädt beim Neustart herunter und installiert. .deb: Paket in Ordner laden oder nur GitHub-Link; Changelog und SHA-512 im Dialog.",
  ...
  Object.assign(en.settings.accounts, {
    ...
    "deleteWarning": "Gesamte WhatsApp-Web-Sitzung wird gelöscht (Cookies, Speicher, IndexedDB, Service Workers, HTTP-Cache). Unwiderruflich.",
  ...
  Object.assign(en.settings.notifications, {
    ...
    "riseHint": "Hinweis bei steigenden Ungelesenen (Limit pro Konto). Klick fokussiert Fenster und aktiviert Konto."
  });
  Object.assign(en.settings.performance, {
    "gpuBoost": "GPU-Boost beim Start (experimentell)",
    "gpuInfo": "Catrip Connect nutzt Chromium-GPU. Unter Linux opakes Fenster. Nur bei schwarzem Bildschirm deaktivieren: CATRIP_DISABLE_GPU=1.",
    "gpuBoostHint": "Aktiviert verstärkte Rasterisierung, Zero-Copy und erweitertes VA-API unter Linux. Nach Änderung neu starten.",
    ...
    "suspendHint": "Spart RAM durch Schließen ungenutzter WhatsApp-Ansichten; Sitzung bleibt. Sofortiges Neuladen. Im Ruhezustand ggf. keine Benachrichtigungen.",
    ...
    "mediaDiagFootnote": "Wenn decodingInfo_mp4_h264_aac.supported false ist oder MP4 abgelehnt wird, kann Audio/Video fehlschlagen."
  });
  Object.assign(en.settings.network, {
    "proxy": "Netzwerkproxy",
  ...
  Object.assign(en.app.rail, {
    ...
    "tooltip": "{{label}} · {{status}}{{unread}}{{suspended}} · Ziehen zum Sortieren · Rechtsklick: Variante"
  });
  Object.assign(en.app.palette, {
  ...
  Object.assign(en.main.updates, {
    ...
    "integrityFail": "Die SHA-512-Prüfsumme der heruntergeladenen Datei stimmt nicht mit GitHub überein.",
    ...
    "debPromptHint": ".deb-Paket in einen Ordner Ihrer Wahl herunterladen?\n(Alternativ können Sie den GitHub-Link öffnen.)",
    "debManualFooterHint": "Laden Sie das .deb-Installationspaket von herunter:\n{{debUrl}}\n\nInstallieren Sie es dann mit apt oder Ihrem Paketmanager.",
    "debInstallHint": "Installieren mit:\nsudo apt install ./{{filename}}",
    "restartFooterHint": "Die App wird neu gestartet, um das Update anzuwenden.{{integrityLine}}",
    "previewFooterHint": "Vorschau des Update-Dialogs (Entwicklung). Scrollen Sie, um alle Hinweise zu lesen.",
  ...
  Object.assign(en.main.integrations, {
    ...
    "protocolRegistered": "whatsapp:// registriert. https://wa.me im Browser geht nicht automatisch: whatsapp://, Öffnen mit… oder Erweiterung.",
  ...
  Object.assign(en.main.diagnostics, {
    ...
    "whatsappNotLoaded": "Das aktive Konto zeigt web.whatsapp.com noch nicht. Öffnen Sie WhatsApp Web im eingebetteten Browser und versuchen Sie es erneut.",
...
function assignKo(en) {
  ...
  Object.assign(en.settings.language.whatsappNotice, {
    ...
    "intro":
      "Catrip Connect 언어(메뉴, 알림 및 앱 텍스트)는 방금 선택한 언어로 업데이트되었습니다.",
  ...
  Object.assign(en.settings.general, {
    ...
    "updateChannelHint": "AppImage: 재시작 시 설치. .deb: 폴더에 받거나 GitHub 링크만 열기; 대화상자에 changelog와 SHA-512 표시.",
  ...
  Object.assign(en.settings.accounts, {
    ...
    "deleteWarning": "WhatsApp Web 세션이 영구 삭제됩니다(쿠키, 로컬 저장소, IndexedDB, Service Worker, HTTP 캐시). 되돌릴 수 없습니다.",
  ...
  Object.assign(en.settings.performance, {
    ...
    "gpuInfo": "Catrip Connect는 Chromium GPU 사용. Linux에서 기본 불투명. 검은 화면만 GPU 끄기: CATRIP_DISABLE_GPU=1.",
    ...
    "suspendHint": "사용하지 않는 계정의 WhatsApp 뷰를 닫아 RAM 절약; 세션 유지. 복귀 시 즉시 로드. 휴면 중 알림 미갱신 가능.",
    ...
    "mediaDiagFootnote": "decodingInfo_mp4_h264_aac.supported가 false이거나 MP4 MIME이 거부되면 오디오/비디오가 실패할 수 있습니다."
  });
  Object.assign(en.settings.network, {
    "proxy": "네트워크 프록시",
    "proxyRules": "프록시 규칙",
  ...
  Object.assign(en.main.updates, {
    ...
    "debPromptHint": "선택한 폴더에 .deb 패키지를 다운로드할까요?\n(앱에서 다운로드하지 않으려면 GitHub 링크를 열 수 있습니다.)",
    "debManualFooterHint": "다음에서 .deb 설치 파일을 다운로드하세요:\n{{debUrl}}\n\n그런 다음 apt 또는 패키지 관리자로 설치하세요.",
    "debInstallHint": "설치:\nsudo apt install ./{{filename}}",
    "restartFooterHint": "업데이트를 적용하려면 앱이 다시 시작됩니다.{{integrityLine}}",
    "previewFooterHint": "업데이트 대화 상자 미리보기(개발). 모든 릴리스 노트를 읽으려면 스크롤하세요.",
  ...
  Object.assign(en.main.integrations, {
    ...
    "protocolRegistered": "whatsapp:// 등록됨. 브라우저 wa.me는 자동 전달 안 됨: whatsapp://, 열기… 또는 확장 사용.",
  ...
  Object.assign(en.main.diagnostics, {
    ...
    "whatsappNotLoaded": "활성 계정에 아직 web.whatsapp.com이 표시되지 않습니다. 내장 브라우저에서 WhatsApp Web을 연 뒤 다시 시도하세요.",
...
function assignJa(en) {
  ...
  Object.assign(en.settings.general, {
    ...
    "updateChannelHint": "AppImage: 再起動でインストール。.deb: フォルダ保存または GitHub のみ; ダイアログに changelog と SHA-512。",
  ...
  Object.assign(en.settings.performance, {
    ...
    "suspendHint": "未使用アカウントの WhatsApp ビューを閉じて RAM 節約。セッション維持。復帰は即時。休止中は通知更新されない場合あり。",
    ...
    "mediaDiagFootnote": "decodingInfo_mp4_h264_aac.supported が false または MP4 が拒否されると失敗する場合があります。"
  });
  Object.assign(en.settings.network, {
    "proxy": "ネットワークプロキシ",
    "proxyRules": "プロキシ規則",
  ...
  Object.assign(en.app.rail, {
    ...
    "zen": "Zen モード (Esc で終了)",
    "suspended": " · 休止中（メモリ節約）",
    "tooltip": "{{label}} · {{status}}{{unread}}{{suspended}} · ドラッグで並べ替え · 右クリック: バリアント"
  });
  Object.assign(en.app.palette, {
    "title": "コマンドパレット",
  ...
  Object.assign(en.main.updates, {
    ...
    "debPromptHint": "選択したフォルダに .deb パッケージをダウンロードしますか？\n（アプリからダウンロードしない場合は GitHub リンクを開けます。）",
    "debManualFooterHint": "次から .deb インストーラーをダウンロード:\n{{debUrl}}\n\napt またはパッケージマネージャーでインストールしてください。",
    "debInstallHint": "インストール:\nsudo apt install ./{{filename}}",
    "restartFooterHint": "更新を適用するためアプリを再起動します。{{integrityLine}}",
    "previewFooterHint": "更新ダイアログのプレビュー（開発）。すべてのリリースノートを読むにはスクロールしてください。",
  ...
  Object.assign(en.main.diagnostics, {
    ...
    "whatsappNotLoaded": "アクティブなアカウントはまだ web.whatsapp.com を表示していません。内蔵ブラウザで WhatsApp Web を開いて再試行してください。",
...
function assignIt(en) {
  ...
  Object.assign(en.settings.general, {
    ...
    "registerProtocolHint": "whatsapp:// — Dopo la registrazione il sistema può aprire link compatibili in Catrip.",
    ...
    "updateChannelHint": "AppImage: installa al riavvio. .deb: scarica in cartella o solo link GitHub; changelog e SHA-512 nel dialogo.",
  ...
  Object.assign(en.settings.notifications, {
    ...
    "riseHint": "Avviso quando aumentano i non letti (limite per account). Clic focalizza e attiva account."
  });
  Object.assign(en.settings.performance, {
    "gpuBoost": "Boost GPU all'avvio (sperimentale)",
    "gpuInfo": "Usa GPU Chromium. Su Linux finestra opaca. Disattiva solo con schermo nero: CATRIP_DISABLE_GPU=1.",
    "gpuBoostHint": "Abilita rasterizzazione rinforzata, zero-copy e VA-API esteso su Linux. Riavvia dopo le modifiche.",
    ...
    "suspendHint": "Libera RAM chiudendo WhatsApp inutilizzati; sessione conservata. Ritorno istantaneo. In sospensione notifiche possono non aggiornarsi.",
    ...
    "mediaDiagFootnote": "Se decodingInfo_mp4_h264_aac.supported è false o MP4 viene rifiutato, audio/video può fallire."
  });
  Object.assign(en.settings.network, {
    "proxy": "Proxy di rete",
  ...
  Object.assign(en.app.rail, {
    ...
    "tooltip": "{{label}} · {{status}}{{unread}}{{suspended}} · Trascina per riordinare · Tasto destro: variante"
  });
  Object.assign(en.app.palette, {
  ...
  Object.assign(en.main.updates, {
    ...
    "integrityFail": "Il checksum SHA-512 del file scaricato non coincide con quello pubblicato su GitHub.",
  ...
  Object.assign(en.main.diagnostics, {
    ...
    "whatsappNotLoaded": "L'account attivo non mostra ancora web.whatsapp.com. Apri WhatsApp Web nel browser integrato e riprova.",
...
function assignZh(en) {
  ...
  Object.assign(en.settings.general, {
    ...
    "updateChannelHint": "AppImage：重启时安装。.deb：可下载到文件夹或仅打开 GitHub 链接；对话框显示 changelog 和 SHA-512。",
  ...
  Object.assign(en.settings.performance, {
    ...
    "suspendHint": "关闭未使用账户的 WhatsApp 视图以节省 RAM；会话保留。返回时即时加载。休眠时通知可能不更新。",
    ...
    "mediaDiagFootnote": "若 decodingInfo_mp4_h264_aac.supported 为 false 或拒绝 MP4，音视频可能失败。"
  });
  Object.assign(en.settings.network, {
    "proxy": "网络代理",
    "proxyRules": "代理规则",
  ...
  Object.assign(en.main.diagnostics, {
    ...
    "whatsappNotLoaded": "活动账户尚未显示 web.whatsapp.com。请在内置浏览器中打开 WhatsApp Web 后重试。",
    "genericError": "发生错误。"
  });
  en.main.desktop ??= {};
  Object.assign(en.main.desktop, {
